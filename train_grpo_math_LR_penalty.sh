...
export N_GPUS=8
export BASE_MODEL=Qwen/Qwen2.5-Math-1.5B # meta-llama/Llama-3.1-8B 
...
export EXPERIMENT_NAME=math-grpo-${BASE_MODEL_SHORT_NAME}-8h20-${RESPONSE_LENGTH}-lr-penalty
